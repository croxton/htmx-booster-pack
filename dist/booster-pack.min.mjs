      ...
      onEvent: function(name, htmxEvent) {
        ...
        switch (name) {
          case "htmx:beforeSwap": {
            ...
            incomingDOM && saveToCache(incomingDOM, "next"), (_c = factory == null ? void 0 : factory.beforeUnmount) == null || _c.call(factory), cache.clean = !1;
            break;
          }
          case "htmx:afterSettle":
            htmx.config.currentTargetId = ((_d = htmxEvent.target) == null ? void 0 : _d.id) || "main", (_e = factory == null ? void 0 : factory.refresh) == null || _e.call(factory), cache.clean = !0;
            break;
          case "htmx:beforeHistorySave":
            cache.clean && ((_f = factory == null ? void 0 : factory.beforeUnmount) == null || _f.call(factory));
            break;
