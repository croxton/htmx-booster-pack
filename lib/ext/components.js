...
class HtmxComponent {
	...
	setState(scope = "local", changes) {
		...
		if (scope === 'global') {
			stateRef = HtmxComponent._globalState;
		} else if (scope === 'component') {
			if (!HtmxComponent._globalState.hasOwnProperty(this.constructor.name)) {
				HtmxComponent._globalState[this.constructor.name] = {};
			}
			stateRef = HtmxComponent._globalState[this.constructor.name];
		}
